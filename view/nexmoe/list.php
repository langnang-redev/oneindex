...
foreach ((array)$items as $item) {
  if (empty($item['folder'])) {
    ...
    if (file_ico($item) == "ondemand_video") {
      array_push($videoItems, $item);
    }
    if (file_ico($item) == "audiotrack") {
      array_push($audioItems, $item);
    }
    if (file_ico($item) == "picture_as_pdf") {
      array_push($pdfItems, $item);
    }
  }
}
    ...
    <div class="mdui-row">
      <ul class="mdui-list">
        ...
        <?php foreach ((array)$items as $index => $item) : ?>
          ...
          <?php elseif (file_ico($item) == 'ondemand_video') : ?>
            <li class="mdui-list-item file mdui-ripple">
              <a href="javascript:void 0" data-type="<?php echo file_ico($item); ?>" data-url="<?php e($item['downloadUrl']); ?>" data-key="<?php echo $index; ?>" onclick="play_video.call(this)">
                <div class="mdui-col-xs-12 mdui-col-sm-7 mdui-text-truncate">
          ...
          <?php elseif (file_ico($item) == 'audiotrack') : ?>
            <li class="mdui-list-item file mdui-ripple">
              <a href="javascript:void 0" data-type="<?php echo file_ico($item); ?>" data-url="<?php e($item['downloadUrl']); ?>" data-key="<?php echo $index; ?>" onclick="play_audio.call(this)">
                <div class="mdui-col-xs-12 mdui-col-sm-7 mdui-text-truncate">
                  <i class="mdui-icon material-icons"><?php echo file_ico($item); ?></i>
                  <span><?php e($item['name']); ?></span>
                </div>
...
<script src="/view/nexmoe/js/list.js"></script>
